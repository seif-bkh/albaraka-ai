-- V1__baseline_schema.sql — exact copy of specs/db/schema.sql (reference DDL, Phase 1 bootstrap)
-- Regenerate: cp specs/db/schema.sql server/assistant-boot/src/main/resources/db/migration/V1__baseline_schema.sql
...
CREATE TABLE collection (
  ...
  chunking_policy        jsonb        NOT NULL DEFAULT '{"strategy":"PARAGRAPH","minTokens":200,"maxTokens":800}'::jsonb,
  description_fr         text,
  description_ar         text,
  description_en         text,
